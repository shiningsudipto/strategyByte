...
const MeetingContent = () => {
  ...
  return (
    <div className="bg-white rounded-[24px] grid lg:grid-cols-5 grid-cols-1">
      <div className="col-span-2 lg:p-10 p-5 border-r border-[#0000001A]">
      ...
      <div className="col-span-3 lg:p-10 p-5">
        <p className="text-neutral-700 text-xl font-bold lg:mb-0 mb-5">
          Enter Details
        </p>
        <MeetingForm />
      </div>
