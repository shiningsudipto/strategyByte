...
export const marketing = {
  title: "Delivering Measurable Digital Marketing & SEO Results For",
...
export const organizations = {
  ...
  title_fallback: "Trust By 30+ organizations",
};
...
export const importancy = {
  subtitle: "Why Digital Marketing",
  title: "Matters For Your Australian Business",
  description:
    "In today’s digital-first world, your online presence driven by effective digital marketing and SEO is often the first touchpoint for potential customers.",
  strategies: [
    {
...
export const impact = {
  subtitle: "Proven Impacts",
  title: "Grow Your Organic Traffic",
  description:
    "Whether you're starting your first SEO campaign or building on an existing strategy, our team will align with your business goals to drive new traffic and attract potential customers to your website.",
  cta: "FREE! 1 Hour Growth Talk",
};

export const seoServices = {
  title: "Comprehensive Digital Marketing Services for",
  title_highlight: "Australian Businesses",
  description:
...
export const marketingFields = {
  ...
  description:
    "At StrategyByte, we understand that different industries have unique digital marketing needs. Our team brings specialized expertise across multiple sectors to deliver tailored marketing solutions that drive results.",
  industries: [
    {
      title: "Corporate",
...
export const successStories = {
  title: "Our Digital Marketing & SEO Success Stories",
  description:
...
export const offering = {
  title: "See All That",
  title_highlight: "What We Are Offering",
  description:
    "Our approach is designed to maximize the impact of your marketing efforts by delivering measurable ROI. We focus on strategic allocation of resources, ensuring every dollar spent contributes to meaningful growth and business success.",
  button: "View Full Service",
  services: [
