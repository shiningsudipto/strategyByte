...
export const webDevelopment = {
  title: "Delivering Measurable Website Development Results For",
  title_highlight: "Australian Businesses",
  description:
    "We build SEO-ready, high-performance websites that convert. Services include custom WordPress development, front-end optimization, and clean code aligned with Core Web Vitals. As an Australian web development company, we offer transparent website development costs, local support, and sites built to rank and drive enquiries.",
  img: "/services/web/features/Approach Image.png",
  features: [
    {
      serial: "01",
      img: "/services/web/features/sparkles.png",
      title: "1.2s Average Load Time",
      desc: "Core Web Vitals optimised builds that boost SEO and engagement.",
    },
    {
      serial: "02",
      img: "/services/web/features/heart-handshake.png",
      title: "94% Client Satisfaction",
      desc: "Australian clients trust our website and WordPress development.",
    },
    {
      serial: "03",
      img: "/services/web/features/chart-line.png",
      title: "82% Mobile Conversion Lift",
      desc: "Mobile-first UX that turns visits into enquiries.",
    },
    {
      serial: "04",
      img: "/services/web/features/globe.png",
      title: "Wide Portfolio of Live Sites",
      desc: "Proven WordPress and custom web development for Australian businesses.",
    },
    {
      serial: "05",
      img: "/services/web/features/flag.png",
      title: "Google Rankings",
      desc: "SEO-ready architecture and on-page optimisation for page-one results.",
    },
    {
      serial: "06",
      img: "/services/web/features/headphones.png",
      title: "Fast Support Response",
      desc: "Fast, Australian-based maintenance and updates when you need them.",
    },
  ],
};
...
export const webDevInfo = {
  ...
  title: "Web Development Services in Australia?",
  description:
    "Your website is your digital portfolio and quickest way to reach customers. It runs 24/7, showing who you are, what you offer, and why you can be trusted. A fast, well-designed site improves Google visibility, answers questions, showcases reviews and case studies, and turns visitors into enquiries with clear CTAs, chat, and bookings.",
  strategies: [
    {
      title: "Scalability",
      description:
        "Modular builds and flexible integrations let your site grow from startup to enterprise without costly rebuilds.",
    },
    {
      title: "Performance",
      description:
        "Optimised code, caching, and images deliver fast load times that lift rankings and conversions.",
    },
    {
      title: "Usability",
      description:
        "Clear navigation and accessible design guide visitors to key actions, boosting enquiries and sales.",
    },
    {
      title: "Security",
      description:
        "Hardened WordPress, regular updates, and backups protect your data and keep your site online.",
    },
    {
      title: "SEO",
      description:
    ...
    },
    {
      title: "Support",
      description:
        "Reliable, Australian-based maintenance and quick turnarounds keep your website performing at its best.",
    },
  ],
};

export const webDevImportance = {
  subtitle: "Why Web Development",
  ...
  strategies: [
    {
      title: "Building Credibility with Expert Web Development",
      description:
        "A professional website establishes credibility and trustworthiness. In Australia’s competitive market, our web development services ensure your site reflects the quality of your business, building confidence from the first click.",
    },
    {
      title: "Making a Lasting Impression",
      description:
        "Visitors form an opinion about your site in just 50 milliseconds. Our strategic design approach ensures that first impression is positive, engaging visitors and keeping them on your site.",
    },
    {
      title: "Driving Conversions with Powerful Websites",
      description:
        "Consumers increasingly turn to online research before making purchases. We craft websites that not only capture attention but also drive conversions, giving you a competitive edge in Australia’s digital marketplace.",
    },
  ],
};
